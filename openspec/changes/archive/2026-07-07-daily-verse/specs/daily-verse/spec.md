...
Public users MUST be able to view past remaining published verses ordered by latest system-controlled timestamp first. The system SHALL support multiple entries with the same date.
...
- THEN the older verses are shown newest-first
