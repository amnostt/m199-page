...
function buildSuccessPayload() {
  return {
    ...
    missionsTitle: "PR4 SSR proof — missions title",
    missionsDescription: "PR4 SSR proof — missions description",
    publicationsTitle: "PR4 SSR proof — publications title",
    publicationsDescription: "PR4 SSR proof — publications description",
    aboutTitle: "PR4 SSR proof — about title",
